...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>查看并审核APP信息 <i class="fa fa-user"></i>${backend_user.userName}</h2>
             <div class="clearfix"></div>
      </div>
      <div class="x_title">
            <h2>APP基础信息</h2>
      ...
      <div class="x_content1">
        <form class="form-horizontal form-label-left" action="/app_check/check" method="post">
          <input type="hidden" name="id" value="${info.id}">
          <div class="item form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">软件名称 <span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input class="form-control col-md-7 col-xs-12" value="${info.softwareName}"
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              value="${info.APKName}" readonly="readonly">
            </div>
          </div>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input class="form-control col-md-7 col-xs-12" 
              	value="${info.supportROM}" type="text" readonly="readonly">
            </div>
          </div>
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input class="form-control col-md-7 col-xs-12" readonly="readonly"
              	value="${info.interfaceLanguage}" type="text">
            </div>
          </div>
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" value="${info.softwareSize}"
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" value="${info.downloads}"
               class="form-control col-md-7 col-xs-12" readonly="readonly">
            </div>
          </div>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" class="form-control col-md-7 col-xs-12" 
              	value="${info.pingtaiName}" readonly="readonly">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" class="form-control col-md-7 col-xs-12" 
              	value="${info.level1Name} --> ${info.level2Name} --> ${info.level3Name}" readonly="readonly">
            </div>
          </div>
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
            	<input type="text" class="form-control col-md-7 col-xs-12" 
              	value="${info.statusName}" readonly="readonly">
            </div>
          </div>
          <div class="item form-group">
           ...
           <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
			 <c:choose> 
				  <c:when test="${info.logoPicPath == null || info.logoPicPath == ''}">
				    	暂无
				  </c:when> 
				  <c:otherwise>   
				    <img src="${info.logoPicPath }" width="100px;"/>
				  </c:otherwise> 
              </c:choose> 
            </div>
          </div>
        ...
        <form class="form-horizontal form-label-left">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="number" value="${version.versionSize }" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          ...
          <div class="item form-group">
           ...
           <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
            <c:choose> 
			  <c:when test="${version.downloadLink == null || version.downloadLink == ''}">
			    	暂无
			  </c:when> 
			  <c:otherwise>   
			    <p>${version.apkFileName}&nbsp;&nbsp;
			    <a href="/app_check/upload?filename=${version.downloadLink}" >下载</a>
			    </p>
			  </c:otherwise> 
            </c:choose> 
            </div>
